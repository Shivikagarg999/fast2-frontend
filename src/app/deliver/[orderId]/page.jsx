    ...
    return (
      <div className="flex flex-col items-center justify-center h-screen gap-4 px-6 text-center">
        ...
        <button
          ...
          className="mt-2 px-5 py-2.5 bg-brand-500 text-white rounded-xl font-semibold text-sm"
        >
          View Orders
        </button>
      </div>
    ...
    <div className="flex flex-col bg-gray-50" style={{ height: 'calc(100vh - 70px)' }}>
      ...
      <div className="bg-white border-b px-4 py-3 flex items-center gap-3 shadow-sm z-10">
        ...
        <div className="flex items-center gap-1.5">
          <span className={`w-2 h-2 rounded-full ${connected ? 'bg-brand-500' : 'bg-gray-300'}`} />
