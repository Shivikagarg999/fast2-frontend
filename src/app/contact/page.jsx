  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white flex flex-col">
        ...
        <div className="max-w-7xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <button
              ...
              className="mt-8 inline-flex items-center px-8 py-3 rounded-xl bg-white text-brand-700 font-semibold shadow-lg hover:bg-brand-50 transition-colors"
            >
              Send us a Message
            </button>
          </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        {/* Status Messages */}
        {status.message && (
          <div className={`mb-8 p-4 rounded-lg ${status.type === 'success' ? 'bg-brand-50 border border-brand-200' : 'bg-red-50 border border-red-200'}`}>
            <div className="flex items-center">
              {status.type === 'success' ? (
                <CheckCircleIcon className="h-5 w-5 text-brand-400 mr-3" />
              ) : (
                <ExclamationCircleIcon className="h-5 w-5 text-red-400 mr-3" />
              )}
              <p className={`text-sm ${status.type === 'success' ? 'text-brand-800' : 'text-red-800'}`}>
                {status.message}
              </p>
            </div>
          </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={handleChange}
                  className={`block w-full px-4 py-3 rounded-lg border ${
                    formErrors.email ? 'border-red-300 focus:border-red-500 focus:ring-red-500' : 'border-gray-300 focus:border-brand-500 focus:ring-brand-500'
                  } shadow-sm focus:ring-2 focus:ring-opacity-50 transition-colors`}
              ...
              <div>
                ...
                <input
                  ...
                  onChange={handleChange}
                  className={`block w-full px-4 py-3 rounded-lg border ${
                    formErrors.phone ? 'border-red-300 focus:border-red-500 focus:ring-red-500' : 'border-gray-300 focus:border-brand-500 focus:ring-brand-500'
                  } shadow-sm focus:ring-2 focus:ring-opacity-50 transition-colors`}
              ...
              <div>
                ...
                <select
                  ...
                  onChange={handleChange}
                  className={`block w-full px-4 py-3 rounded-lg border ${
                    formErrors.subject ? 'border-red-300 focus:border-red-500 focus:ring-red-500' : 'border-gray-300 focus:border-brand-500 focus:ring-brand-500'
                  } shadow-sm focus:ring-2 focus:ring-opacity-50 transition-colors`}
                >
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={handleChange}
                  className={`block w-full px-4 py-3 rounded-lg border ${
                    formErrors.message ? 'border-red-300 focus:border-red-500 focus:ring-red-500' : 'border-gray-300 focus:border-brand-500 focus:ring-brand-500'
                  } shadow-sm focus:ring-2 focus:ring-opacity-50 transition-colors`}
