            ...
            <div className="relative z-10 pb-8 bg-transparent sm:pb-16 md:pb-20 lg:max-w-2xl lg:w-full lg:pb-28 xl:pb-32">
              <div className="pt-10 px-4 sm:px-6 lg:px-8 lg:pt-16 lg:pr-0">
                <div className="lg:self-center">
                  ...
                  <p className="mt-5 text-xl text-purple-100 max-w-xl">
        ...
        <div className="py-16 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="flex justify-center mb-12">
              <div className="flex space-x-1 rounded-xl bg-purple-900/10 p-1">
                <button
                ...
                <div className="space-y-12">
                  <div className="text-center">
                    ...
                    <div className="mt-6 prose prose-lg text-gray-600 mx-auto max-w-4xl">
                      ...
                      <div className="mt-10 bg-gradient-to-r from-purple-50 to-indigo-50 rounded-2xl p-8">
                        <h3 className="text-2xl font-semibold text-purple-900 mb-6">What Makes Us Different</h3>
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                      {features.map((feature) => (
                        <div key={feature.name} className="relative bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition-shadow duration-300">
                          <div className="absolute -top-4 left-6 flex items-center justify-center h-12 w-12 rounded-xl bg-gradient-to-r from-purple-500 to-purple-600 text-white shadow-lg">
                    ...
                    <div className="bg-gradient-to-br from-purple-50 to-purple-100 rounded-2xl p-8 mb-12 border border-purple-200">
                      <div className="flex items-center mb-6">
                        ...
                        <div className="ml-4">
                          ...
                          <p className="text-purple-700">Driving Purpose & Commitment</p>
                        </div>
                      </div>
                        ...
                        {values.map((value) => (
                          <div key={value.name} className="bg-white rounded-xl p-6 shadow-md hover:shadow-lg transition-shadow duration-300 border border-gray-100">
                            <div className="flex justify-center mb-4">
                              <div className="h-14 w-14 rounded-full bg-gradient-to-r from-purple-500 to-purple-600 flex items-center justify-center">
                  ...
                  <div className="max-w-4xl mx-auto">
                    ...
                    <div className="grid md:grid-cols-2 gap-8">
                      {leadership.map((person, index) => (
                        <div key={person.name} className={`rounded-2xl overflow-hidden shadow-xl ${index === 0 ? 'bg-gradient-to-br from-yellow-50 to-orange-50' : 'bg-gradient-to-br from-purple-50 to-cyan-50'}`}>
                          <div className="p-8">
                            <div className="flex items-center mb-6">
                              <div className={`h-16 w-16 rounded-full flex items-center justify-center ${index === 0 ? 'bg-gradient-to-r from-yellow-500 to-orange-500' : 'bg-gradient-to-r from-purple-500 to-cyan-500'}`}>
                                <person.icon className="h-8 w-8 text-white" />
                              </div>
                              <div className="ml-6">
                                <h3 className="text-2xl font-bold text-gray-900">{person.name}</h3>
                                <p className={`text-lg font-semibold ${index === 0 ? 'text-orange-600' : 'text-purple-600'}`}>
                                  {person.role}
                                </p>
                              </div>
                            </div>
                  ...
                  <div className="max-w-4xl mx-auto">
                    <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
                      <div className="md:flex">
                        {/* Contact Details */}
                        <div className="md:w-1/2 bg-gradient-to-br from-purple-600 to-purple-800 p-8 text-white">
                          <h3 className="text-2xl font-bold mb-8">Contact Details</h3>
                          
                          <div className="space-y-6">
                            <div className="flex items-start">
                              <MapPinIcon className="h-6 w-6 text-purple-200 mt-1 flex-shrink-0" />
                              <div className="ml-4">
                                <h4 className="font-semibold text-purple-100">Address</h4>
                            ...
                            <div className="flex items-start">
                              <EnvelopeIcon className="h-6 w-6 text-purple-200 mt-1 flex-shrink-0" />
                              <div className="ml-4">
                                <h4 className="font-semibold text-purple-100">Email</h4>
                                <a href="mailto:support@fast2.in" className="mt-1 text-purple-50 hover:text-yellow-300 transition-colors">
                                  support@fast2.in
                                </a>
                              </div>
                            </div>
                            ...
                            <div className="flex items-start">
                              <GlobeAltIcon className="h-6 w-6 text-purple-200 mt-1 flex-shrink-0" />
                              <div className="ml-4">
                                <h4 className="font-semibold text-purple-100">Website</h4>
                                <a href="https://www.fast2.in" target="_blank" rel="noopener noreferrer" className="mt-1 text-purple-50 hover:text-yellow-300 transition-colors">
                                  www.fast2.in
                                </a>
                              </div>
                            </div>
                          ...
                          <div className="mt-12 pt-8 border-t border-purple-500/30">
                            <h4 className="text-lg font-semibold text-purple-100 mb-4">Business Hours</h4>
                          ...
                          <form className="space-y-6">
                            <div>
                              ...
                              <input
                                type="text"
                                id="name"
                                className="mt-1 block w-full rounded-lg border border-gray-300 px-4 py-3 shadow-sm focus:border-purple-500 focus:ring-purple-500"
                            ...
                            <button
                              type="submit"
                              className="w-full bg-gradient-to-r from-purple-600 to-purple-700 text-white font-semibold py-3 px-4 rounded-lg hover:from-purple-700 hover:to-purple-800 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 transition-all duration-300"
                            >
                              Send Message
                            </button>
                          </form>
          ...
          <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8 lg:flex lg:items-center lg:justify-between">
            ...
            <div className="mt-8 flex lg:mt-0 lg:flex-shrink-0">
              <div className="inline-flex rounded-lg shadow">
                <a
                  href="/"
                  className="inline-flex items-center justify-center px-6 py-3 border border-transparent text-base font-medium rounded-lg text-purple-700 bg-white hover:bg-purple-50 transition-colors duration-300"
                >
                  Start Shopping Now
