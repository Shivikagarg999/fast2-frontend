...
function ShopsContent() {
    ...
    return (
        <div className="min-h-screen bg-gray-50 flex flex-col">
            {/* Hero Section */}
            <div className="bg-gradient-to-br from-brand-600 via-purple-600 to-pink-500 text-white">
                    ...
                    <div className="text-center">
                        ...
                        <form onSubmit={handleSearch} className="max-w-xl mx-auto relative">
                            <div className="flex items-center bg-white rounded-full shadow-lg overflow-hidden">
                                ...
                                <button
                                    type="submit"
                                    className="bg-brand-600 hover:bg-brand-700 text-white px-6 py-3.5 font-semibold text-sm transition-colors"
                                >
                                    Search
                                </button>
                            </div>
                    ...
                    <div className="flex items-center gap-3 flex-wrap">
                        ...
                        <div className="relative">
                            <select
                                ...
                                className="appearance-none bg-white border border-gray-200 rounded-full px-4 py-2 pr-8 text-sm text-gray-700 cursor-pointer hover:border-brand-300 focus:outline-none focus:border-brand-400"
                            >
                        ...
                        <div className="relative">
                            <input
                                ...
                                className="bg-white border border-gray-200 rounded-full px-4 py-2 text-sm text-gray-700 w-36 focus:outline-none focus:border-brand-400 placeholder:text-gray-400"
                            />
                        </div>
                        ...
                        <div className="relative">
                            <input
                                ...
                                className="bg-white border border-gray-200 rounded-full px-4 py-2 text-sm text-gray-700 w-28 focus:outline-none focus:border-brand-400 placeholder:text-gray-400"
                            />
                        </div>
                    </div>
            ...
            <div className="max-w-7xl mx-auto px-4 pb-12">
                ...
                {loading ? (
                    ...
                    <div className="text-center py-20">
                        ...
                        <button
                            onClick={clearFilters}
                            className="bg-brand-600 hover:bg-brand-700 text-white px-6 py-2 rounded-full font-medium transition-colors"
                        >
                            Clear Filters
                        </button>
                    </div>
