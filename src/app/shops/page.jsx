                    ...
                    <div className="text-center">
                        ...
                        <form onSubmit={handleSearch} className="max-w-xl mx-auto relative">
                            <div className="flex items-center bg-white rounded-full shadow-lg overflow-hidden">
                                ...
                                <button
                                    type="submit"
                                    className="bg-blue-600 hover:bg-blue-700 text-white px-6 py-3.5 font-semibold text-sm transition-colors"
                                >
                                    Search
                                </button>
                            </div>
                    ...
                    <div className="flex items-center gap-3 flex-wrap">
                        ...
                        <div className="relative">
                            <select
                                ...
                                className="appearance-none bg-white border border-gray-200 rounded-full px-4 py-2 pr-8 text-sm text-gray-700 cursor-pointer hover:border-blue-300 focus:outline-none focus:border-blue-400"
                            >
                        ...
                        <div className="relative">
                            <input
                                ...
                                className="bg-white border border-gray-200 rounded-full px-4 py-2 text-sm text-gray-700 w-36 focus:outline-none focus:border-blue-400 placeholder:text-gray-400"
                            />
                        </div>
                        ...
                        <div className="relative">
                            <input
                                ...
                                className="bg-white border border-gray-200 rounded-full px-4 py-2 text-sm text-gray-700 w-28 focus:outline-none focus:border-blue-400 placeholder:text-gray-400"
                            />
                        </div>
                    </div>
