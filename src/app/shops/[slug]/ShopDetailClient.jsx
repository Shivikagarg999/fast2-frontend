...
export default function ShopDetailClient() {
    ...
    return (
        <div className="min-h-screen bg-gray-50 pb-10 flex flex-col">
            {/* Login Prompt */}
            {showLoginPrompt && (
                <div className="fixed top-20 left-1/2 transform -translate-x-1/2 bg-brand-600 text-white px-6 py-3 rounded-lg shadow-lg z-50">
            ...
            <div className="bg-white border-b border-gray-200">
                ...
                <div className="h-48 md:h-64 bg-gray-100 relative overflow-hidden">
                    {shop.coverImage?.url ? (
                        ...
                        <div className="w-full h-full bg-gradient-to-r from-brand-50 to-indigo-50" />
                    )}
                </div>
                    ...
                    <div className="relative -mt-12 md:-mt-16 flex flex-col md:flex-row md:items-end gap-6 pb-6">
                        ...
                        <div className="flex-1">
                            ...
                            <div className="flex flex-wrap gap-2 mb-2">
                                {shop.isVerified && (
                                    <span className="flex items-center gap-1 bg-brand-50 text-brand-600 text-sm font-bold px-3 py-1.5 rounded-full border border-brand-200">
                                ...
                                <span className={`flex items-center gap-2 text-sm font-bold px-3 py-1.5 rounded-full ${
                                    ...
                                    <div className={`w-2 h-2 rounded-full ${
                                        isShopOpen() ? 'bg-brand-500' : 'bg-red-500'
                                    }`} />
                        ...
                        <div className="flex flex-wrap items-center gap-6 text-sm">
                            {shop.rating?.average > 0 && (
                                <div className="flex items-center gap-2">
                                    <div className="flex items-center gap-1 bg-brand-500 text-white px-2 py-1 rounded-md">
                        ...
                        <div className="flex items-center gap-3 mb-5 flex-wrap">
                            <form onSubmit={handleProductSearch} className="flex-1 min-w-[200px] relative">
                                ...
                                <input
                                    ...
                                    className="w-full pl-9 pr-4 py-2.5 bg-white border border-gray-200 rounded-full text-sm focus:outline-none focus:border-brand-400"
                                />
                                {productSearchInput && (
                                    <button
                                        type="button"
                            ...
                            <select
                                ...
                                className="bg-white border border-gray-200 rounded-full px-4 py-2.5 text-sm text-gray-700 cursor-pointer focus:outline-none focus:border-brand-400"
                            >
                            ...
                            <>
                                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                                    {products.map((product) => (
                                        <div
                                            key={product._id}
                                            className="bg-white rounded-xl overflow-hidden border border-gray-100 hover:border-brand-200 hover:shadow-md transition-all duration-200 cursor-pointer group flex flex-col"
                                        >
                                            {/* Product Image */}
                                            <div
                                            ...
                                            <div className="p-3 flex-1 flex flex-col" onClick={() => handleProductClick(product)}>
                                                {product.delivery?.deliveryCharges > 0 ? (
                                                    ...
                                                    <span className="text-xs text-brand-600 font-medium mb-1">Free Delivery</span>
                                                )}
                                            ...
                                            <div className="px-3 pb-3">
                                                {product.stockStatus !== 'out-of-stock' && (
                                                    cart[product._id] ? (
                                                        <div className="flex items-center justify-center bg-brand-600 text-white rounded-lg h-9 text-sm font-bold">
                                                        ...
                                                        <button
                                                            ...
                                                            className="w-full bg-brand-50 border border-brand-600 text-brand-700 hover:bg-brand-600 hover:text-white py-2 rounded-lg text-sm font-bold transition-all disabled:opacity-50"
                                                        >
                    ...
                    <div className="mt-6">
                                ...
                                <div className="flex items-center gap-8 flex-wrap">
                                    ...
                                    <div>
                                        <button
                                            ...
                                            className="bg-brand-600 text-white px-6 py-2.5 rounded-full font-medium text-sm hover:bg-brand-700 transition-colors"
                                        >
                                            Write a Review
                                        </button>
                                    </div>
                            ...
                            <div className="bg-white rounded-2xl p-6 border border-gray-100 mb-6">
                                ...
                                <form onSubmit={handleSubmitReview}>
                                    ...
                                    <input
                                        ...
                                        className="w-full border border-gray-200 rounded-xl px-4 py-2.5 text-sm mb-3 focus:outline-none focus:border-brand-400"
                                        maxLength={100}
                                    />
                                    <textarea
                                        ...
                                        className="w-full border border-gray-200 rounded-xl px-4 py-2.5 text-sm mb-4 focus:outline-none focus:border-brand-400 resize-none h-24"
                                        maxLength={1000}
                                    />
                                    <div className="flex items-center gap-3">
                                        <button
                                            ...
                                            className="bg-brand-600 text-white px-6 py-2.5 rounded-full font-medium text-sm hover:bg-brand-700 transition-colors disabled:opacity-50"
                                        >
                        ...
                        <div className="flex items-center gap-2 mb-5 overflow-x-auto">
                            <button
                                ...
                                className={`px-4 py-2 rounded-full text-xs font-medium border transition-colors whitespace-nowrap ${!reviewRatingFilter ? 'bg-brand-50 border-brand-300 text-brand-700' : 'bg-white border-gray-200 text-gray-600'
                                    }`}
                            >
                                All
                            </button>
                            {[5, 4, 3, 2, 1].map((r) => (
                                <button
                                    ...
                                    className={`flex items-center gap-1 px-3 py-2 rounded-full text-xs font-medium border transition-colors whitespace-nowrap ${reviewRatingFilter === r.toString() ? 'bg-brand-50 border-brand-300 text-brand-700' : 'bg-white border-gray-200 text-gray-600'
                                        }`}
                                >
                                    <StarSolidIcon className="w-3 h-3 text-yellow-400" />
                                    {r}
                                ...
                                {reviews.map((review) => (
                                    <div key={review._id} className="bg-white rounded-xl p-5 border border-gray-100">
                                        ...
                                        <div className="flex items-start justify-between mb-3">
                                            <div className="flex items-center gap-3">
                                                <div className="w-10 h-10 bg-gradient-to-br from-brand-400 to-purple-400 rounded-full flex items-center justify-center text-white font-bold text-sm">
                                        ...
                                        {review.sellerResponse?.message && (
                                            <div className="bg-brand-50 rounded-lg p-3 mt-3 border-l-3 border-brand-400">
                                        ...
                                        <div className="flex items-center gap-3 mt-3 pt-3 border-t border-gray-100">
                                            ...
                                            >
                                                {review._voted ? (
                                                    <HandThumbUpSolidIcon className="w-4 h-4 text-brand-500" />
                                                ) : (
                            ...
                            <div className="bg-white rounded-2xl p-6 border border-gray-100">
                                ...
                                <div className="flex gap-3">
                                    ...
                                    {shop.socialLinks.facebook && (
                                        <a href={shop.socialLinks.facebook} target="_blank" rel="noopener noreferrer" className="text-brand-600 hover:text-brand-700 transition-colors">
