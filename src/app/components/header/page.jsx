          ...
          <div className="p-4 border-b border-green-100">
            ...
            <div className="relative mb-3">
              <input
                ...
                className="w-full pl-9 pr-4 py-2 border border-green-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent text-sm"
                value={searchQuery}
              ...
              <div className="space-y-1">
                {commonLocations.map((location, index) => (
                  ...
                  >
                    <div className="flex items-center space-x-3">
                      <MapPinIcon className="w-4 h-4 text-green-400 flex-shrink-0" />
                      <span className="text-sm text-green-700">{location.name}</span>
                    </div>
                    <span className="text-xs text-green-500 bg-green-100 px-2 py-1 rounded">
                      {location.pincode}
                    </span>
              ...
              {isLoggedIn ? (
                <div className="hidden md:flex items-center space-x-3 relative" ref={profileDropdownRef}>
                  ...
                  >
                    ...
                    <ChevronDownIcon className={`w-4 h-4 text-green-500 transition-transform duration-200 ${isProfileDropdownOpen ? 'rotate-180' : ''
                      }`} />
                  </div>
