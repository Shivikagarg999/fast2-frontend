...
export default function Footer() {
  ...
  return (
    <footer className="bg-brand-300 text-black py-8 md:py-10 px-4 md:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-5 gap-x-6 gap-y-8 md:gap-8 mb-6 md:mb-8">
          ...
          <div className="col-span-2">
            ...
            <a
              href="https://play.google.com/store/apps/details?id=com.gmkart.app&hl=en_IN"
              target="_blank"
          ...
          <div className="col-span-2 lg:col-span-1">
            ...
            <div className="flex items-center gap-3 mt-4">
              ...
              <a
                href="https://wa.me/919479467874"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Chat with GMKart on WhatsApp"
                className="w-9 h-9 flex items-center justify-center rounded-full bg-black/10 hover:bg-black/20 transition-colors"
              >
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347zM12.05 22c-1.933 0-3.796-.507-5.436-1.47l-.39-.232-4.03 1.057 1.075-3.926-.254-.403A9.933 9.933 0 012.05 12c0-5.514 4.486-10 10-10s10 4.486 10 10-4.486 10-10 10zm0-20C6.006 2 1.05 6.956 1.05 13c0 2.083.58 4.03 1.586 5.696L1 22.5l3.943-1.577A11.94 11.94 0 0012.05 24c6.043 0 11-4.957 11-11S18.093 2 12.05 2z" />
                </svg>
              </a>
            </div>
          </div>
