          ...
          <div className="bg-white rounded-2xl shadow-lg p-6 text-gray-800">
            <div className="flex items-center space-x-4 mb-4">
              <div className="relative">
                <div className="w-20 h-20 rounded-full bg-brand-100 overflow-hidden flex items-center justify-center border-4 border-white shadow-md">
                  {avatarPreview ? (
                    <img 
                      src={avatarPreview} 
                      alt="Profile" 
        ...
        {success && (
          <div className="bg-brand-50 border border-brand-200 text-brand-700 px-4 py-3 rounded-xl mb-6 shadow-sm">
            <div className="flex justify-between items-center">
              ...
              <button 
                onClick={() => setSuccess('')}
                className="text-brand-800 font-bold text-lg"
              >
                ×
              </button>
            </div>
