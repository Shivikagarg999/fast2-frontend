...
const ProfilePage = () => {
  ...
  const fetchUserProfile = async () => {
    try {
      ...
      const response = await fetch('https://fast2-backend.onrender.com/api/user/profile/', {
        headers: {
  ...
  const uploadAvatar = async () => {
    ...
    try {
      ...
      const response = await fetch('https://fast2-backend.onrender.com/api/user/profile/avatar', {
        method: 'PUT',
        headers: {
          'Authorization': `Bearer ${token}`,
        },
