...
const AddressPage = () => {
  ...
  const fetchAddresses = async () => {
    try {
      ...
      const response = await fetch('http://localhost:5000/api/user/addresses/get', {
  ...
  const createAddress = async () => {
    try {
      ...
      const response = await fetch('http://localhost:5000/api/user/addresses/create', {
        method: 'POST',
        headers: getAuthHeaders(),
  ...
  const updateAddress = async () => {
    try {
      ...
      const response = await fetch(`http://localhost:5000/api/user/addresses/update/${editingAddress._id}`, {
        method: 'PUT',
        headers: getAuthHeaders(),
        body: JSON.stringify(addressForm),
      });
  ...
  const deleteAddress = async (addressId) => {
    try {
      ...
      const response = await fetch(`http://localhost:5000/api/user/addresses/delete/${addressId}`, {
        method: 'DELETE',
        headers: getAuthHeaders(),
      });
  ...
  const setDefaultAddress = async (addressId) => {
    try {
      ...
      const response = await fetch(`http://localhost:5000/api/user/addresses/${addressId}/default`, {
        method: 'PATCH',
        headers: getAuthHeaders(),
      });
