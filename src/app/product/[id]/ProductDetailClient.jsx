    ...
    <div className="min-h-screen bg-gray-50 pb-20 flex flex-col">
      ...
      {cartMessage && (
        <div className={`fixed top-20 left-1/2 transform -translate-x-1/2 px-6 py-3 rounded-lg shadow-lg z-50 ${
          cartMessage.includes('success') ? 'bg-brand-600 text-white' : 'bg-red-600 text-white'
        }`}>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
          <div className="md:flex">
                  ...
                  {discount.hasDiscount && (
                    <div className="absolute top-4 left-4 space-y-2">
                      ...
                      {discount.discountName && (
                        <div className="px-3 py-1 bg-brand-500 text-white text-sm rounded-full font-semibold shadow-lg">
                          {discount.discountName}
                        </div>
                      )}
                    </div>
            ...
            <div className="md:w-3/5 p-8">
              <div className="mb-4">
                <span className="inline-block bg-brand-50 text-brand-700 text-sm px-3 py-1 rounded-full font-medium border border-brand-200">
              ...
              <div className="flex items-center space-x-6 mb-6">
                <div className="flex items-center bg-brand-50 px-3 py-1 rounded-full border border-brand-200">
              ...
              <div className="mb-6 p-4 bg-gray-50 rounded-lg">
                ...
                {discount.hasDiscount && (
                  <span className="text-brand-600 font-semibold text-sm block mt-1">
              ...
              <div className="space-y-3">
                <button
                  ...
                  className="w-full bg-white text-brand-600 py-4 rounded-xl font-semibold text-lg hover:bg-brand-700 hover:text-white disabled:opacity-50 disabled:cursor-not-allowed"
                >
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-8 mt-8">
          ...
          {product.description && product.description.length > 200 && (
            <button
              ...
              className="mt-4 flex items-center text-brand-600 font-medium"
            >
              {showFullDescription ? (
                <>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-sm">
            ...
            <div className="space-y-3">
              ...
              <div className="flex justify-between py-2 border-b border-gray-100">
                ...
                <span className={`font-medium ${product.quantity > 0 ? 'text-brand-600' : 'text-red-600'}`}>
