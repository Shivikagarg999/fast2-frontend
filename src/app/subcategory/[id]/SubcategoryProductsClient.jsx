...
const SubcategoryProductsComponent = () => {
  ...
  // Fix subcategory image URL
  const getSubcategoryImageUrl = (subcategory) => {
    if (!subcategory?.image) return fallbackImage;

    if (subcategory.image.includes('/category/')) {
      return fallbackImage;
    }

    if (subcategory.image.startsWith('/')) {
      return `https://www.fast2.in${subcategory.image}`;
    }
...
export default SubcategoryProductsClient;
