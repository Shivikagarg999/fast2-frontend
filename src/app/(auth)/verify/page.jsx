          ...
          <div className="p-6">
            ...
            <form onSubmit={handleVerifyOTP}>
                ...
                <div className="flex justify-between space-x-2">
                  {otp.map((data, index) => (
                    <input
                      ...
                      className="w-12 h-12 border text-black border-gray-300 rounded-lg text-center text-xl font-semibold focus:ring-purple-500 focus:border-purple-500"
                    />
                  ))}
                </div>
              </div>
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full flex justify-center py-3 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-purple-600 hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500 disabled:opacity-70 disabled:cursor-not-allowed mb-4"
              >
                {loading ? (
                  <>
              ...
              <p className="text-sm text-gray-600">
                ...
                {canResend ? (
                  <button
                    ...
                    className="text-purple-600 font-medium hover:text-purple-700 focus:outline-none"
                  >
                    Resend OTP
                  </button>
                ) : (
