  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {success && (
          <div className="bg-brand-50 border-l-4 border-brand-400 p-4 mb-6 rounded-lg">
            <div className="flex">
              <div className="flex-shrink-0">
              ...
              <div className="ml-3">
                <p className="text-sm text-brand-700">{success}</p>
              </div>
            </div>
          </div>
        )}
        ...
        <div className="grid lg:grid-cols-4 gap-6 mb-8">
          ...
          <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-200">
            <div className="flex items-center">
              <div className="p-3 bg-brand-100 rounded-lg">
                <CurrencyRupeeIcon className="w-6 h-6 text-brand-600" />
              </div>
              <div className="ml-4">
          ...
          <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-200">
            <div className="flex items-center">
              <div className="p-3 bg-brand-100 rounded-lg">
                <GiftIcon className="w-6 h-6 text-brand-600" />
              </div>
              <div className="ml-4">
          ...
          <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-200">
            ...
            <div className="space-y-4">
              ...
              <button
                ...
                className="w-full flex items-center justify-center space-x-2 bg-brand-600 text-white py-3 px-4 rounded-lg hover:bg-brand-700 transition-colors font-medium"
              >
            ...
            {referralStats?.referredBy ? (
              ...
              <form onSubmit={handleApplyReferral} className="space-y-4">
                ...
                <button
                  ...
                  className="w-full bg-brand-600 text-white py-3 px-4 rounded-lg hover:bg-brand-700 focus:outline-none focus:ring-2 focus:ring-brand-500 focus:ring-offset-2 font-medium disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
                >
                  {applying ? (
            ...
            <div className="border-t border-gray-200 pt-4 mt-6">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li className="flex items-start">
                  <span className="w-5 h-5 bg-brand-100 text-brand-600 rounded-full flex items-center justify-center text-xs font-bold mr-2 mt-0.5">1</span>
                  Share your referral code with friends
                </li>
                <li className="flex items-start">
                  <span className="w-5 h-5 bg-brand-100 text-brand-600 rounded-full flex items-center justify-center text-xs font-bold mr-2 mt-0.5">2</span>
                  Friend signs up using your code
                </li>
                <li className="flex items-start">
                  <span className="w-5 h-5 bg-brand-100 text-brand-600 rounded-full flex items-center justify-center text-xs font-bold mr-2 mt-0.5">3</span>
        ...
        <div className="bg-gradient-to-r from-brand-600 to-brand-700 rounded-xl shadow-sm p-8 mt-8 text-white">
          <div className="text-center mb-6">
            <h2 className="text-2xl font-bold mb-2">Earn More With Every Referral</h2>
            <p className="text-brand-100">Unlock amazing rewards as you refer more friends</p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="text-center">
              ...
              <p className="text-brand-100 text-sm">Share your code with friends and family</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-brand-100 text-sm">You get ₹50, your friend gets ₹20</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-brand-100 text-sm">Use your earnings for shopping on GMKart</p>
            </div>
          </div>
        </div>
